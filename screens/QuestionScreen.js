...
import {   Alert,Text, View, Animated, Image, TouchableOpacity,TouchableHighlight,FlatList, StyleSheet, Platform,Dimensions,ScrollView,animating,ActivityIndicator } from 'react-native';
...
//  Alert.alert(this.state.qno);
  ...
  prev = (quesID,testID,userID) =>{
    if(this.qno > 0){
      this.qno--
      this.setState({qimage:arrnew[this.qno].qimage, quest_id:arrnew[this.qno].quest_id,quesNo:arrnew[this.qno].questionNumber, numberVal:arrnew[this.qno].numberID, question: arrnew[this.qno].question, options: arrnew[this.qno].options, correctoption : arrnew[this.qno].correctoption})
 ...
 //  Alert.alert(userID)
    ...
    this.state ={
     ...
     //   Alert.alert(this.state.qno);
         ...
         this.setState({ qimage:arrnew[this.qno].qimage,   quest_id:arrnew[this.qno].quest_id,quesNo:arrnew[this.qno].questionNumber,  countCheck: 0, question: arrnew[this.qno].question, options: arrnew[this.qno].options, correctoption : arrnew[this.qno].correctoption})
...
<View style={{ width:'100%',    flex: 1,flexDirection: 'column', justifyContent: "space-between", alignItems: 'center',zIndex:1}}>
